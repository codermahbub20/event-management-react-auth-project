   ...
   const{img,name,title,description,price,id} = service;
    ...
    return (
        <div>
            ...
            <div data-aos="flip-left" data-aos-duration="2000" className="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
